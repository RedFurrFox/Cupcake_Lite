...
class HelpCog(commands.Cog):
	...
	async def check_is_server_admin(self, SID, UID):
		...
		params = (SID, f"%{UID}%")
		return self.DBH.search_entry(table_name="gserver_configs", search_condition=search_condition, params=params)
		...
		# Page 3  ->  %prefix%help %arg1% %arg2%
			...
			if arg1.lower() in AL.mods:
				...
				# if lacking authority to use this command
					...
					E.description = "You lack authority to view any mods usage/documentation command, you must meet one or more of these criteria:"
					E.add_field(
						name="1.) Server owner",
